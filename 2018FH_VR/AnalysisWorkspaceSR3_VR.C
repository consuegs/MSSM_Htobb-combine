...
int AnalysisWorkspaceSR3_VR()
{
	...
	// A search in a mbb section, define mbb as our variable
	//int m12_min = 390, m12_max = 1270;
	int m12_min = 360, m12_max = 1270;
	RooRealVar mbb("mbb", "m_{12}", m12_min, m12_max);	//SR 3: 600/700/800/900
	RooArgList vars(mbb);
	...
	for (unsigned int mass = 0; mass < srmasses.size(); mass++)
	{
		...
		double TF_pol2_quad_centralValue = 2.21709e-07; //mc
		double TF_pol2_linear_centralValue = 2.08894e-07;
